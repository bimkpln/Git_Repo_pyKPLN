...
try:
    if len(sheets_sorted) == 0:
        forms.alert("Не выбрано ни одного подходящего листа!")
    else:
        components = [ui.forms.flexform.Label("[Том] - [Номер]\n"),
                      ui.forms.flexform.Label("Префикс:"),
                      ui.forms.flexform.TextBox('preffix', Text="АР1"),
                      ui.forms.flexform.Label("Начать номерацию с:"),
                      ui.forms.flexform.TextBox('num', Text="1"),
                      ui.forms.flexform.Label("Нумерация:"),
                      ui.forms.flexform.CheckBox('general',
                                                 '00# вместо #',
                                                 default=False),
