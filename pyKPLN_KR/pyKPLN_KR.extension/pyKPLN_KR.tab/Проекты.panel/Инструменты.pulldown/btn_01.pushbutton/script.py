...
__title__ = "DIV ADSK Параметры"
__doc__ = 'Заполнение параметров «ADSK_Тип квартиры», «ADSK_Тип помещения» «ADSK_Номер квартиры», «ADSK_Номер помещения квартиры»' \
"""
...
try:
	params_found = []
	common_parameters_file = "Z:\\Отдел BIM\\02_Внутренняя документация\\05_ФОП\\ADSK_ФОП2019.txt"
	app = doc.Application
...
if os.path.exists("Z:\\Отдел BIM\\02_Внутренняя документация\\05_ФОП\\ADSK_ФОП2019.txt"):
	...
	forms.alert("Не удалось найти файл общих параметров!\nКаталог: «Z:\\Отдел BIM\\02_Внутренняя документация\\05_ФОП\\ADSK_ФОП2019.txt»")