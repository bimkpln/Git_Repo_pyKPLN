		...
		for element in elements:
			...
			with db.Transaction(name = "copy tempates"):
				...
				try:
					...
					forms.alert("Шаблон «{}» успешно скопирован в проект!".format(str(element.Name)))
				except Exception as e:
					forms.alert("Шаблон «{}» невозможно копировать в проект! Операция отменена! {}".format(str(element.Name), str(e)))
				self.Show()
