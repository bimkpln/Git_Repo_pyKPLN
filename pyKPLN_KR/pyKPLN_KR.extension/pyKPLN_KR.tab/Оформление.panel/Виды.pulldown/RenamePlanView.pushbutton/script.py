...
__title__ = "Переименовать выбранные"
__doc__ = 'Переименовать виды с указанием префикса и постфикса' \
...
try:
    if len(views) == 0:
        ...
        components = [ui.forms.flexform.Label("[Префикс] [Имя уровня] [Постфикс]\n"), ui.forms.flexform.Label("Префикс:"),ui.forms.flexform.TextBox('preffix', Text="КР.#_"), ui.forms.flexform.Label("Постфикс:"), ui.forms.flexform.TextBox('suffix', Text="_Армирование"), ui.forms.flexform.Button("Запуск")]
    if len(views) != 0:
