...
class CreateWindow(Form):
    def __init__(self): 
        ...
        for i in range(0, len(self.rooms_names)):
            ...
            elif self.temp_list[1].lower() in "прихожаягардеробнаякухнякухня-столоваякладовая":
            ...
            elif self.temp_list[1].lower() in "кухня-гостиннаякухня-гостинаяжилая комнатаспальняспальная комната":
    ...
    def is_evro(self, flat):
        for r in flat:
            if r.get_Parameter(self.builtin_room_name_par).AsString() == "Кухня-столовая":
                return True
        return False
                                ...
                                if len(rooms_living) == 0:
                                    ...
                                    if self.is_studio(self.dict_rooms_sorted[i]):
                                        ...
                                        for r in self.dict_rooms_sorted[i]:
                                            ...
                                            par.Set("1Е")
                                            par = r.LookupParameter(par_flat_description)
                                            par.Set("1-комнатная (евродвушка) квартира")
                                    else:
                                        for r in self.dict_rooms_sorted[i]:
                                            par = r.LookupParameter(par_flat_name)
                                            par.Set("1К")
                                    ...
                                    if not self.is_studio(self.dict_rooms_sorted[i]) and not self.is_evro(self.dict_rooms_sorted[i]):
                                        ...
                                        for r in self.dict_rooms_sorted[i]:
                                            ...
                                            par.Set("4Е")
                                            par = r.LookupParameter(par_flat_description)
                                            par.Set("4-комнатная (5Е) квартира")
