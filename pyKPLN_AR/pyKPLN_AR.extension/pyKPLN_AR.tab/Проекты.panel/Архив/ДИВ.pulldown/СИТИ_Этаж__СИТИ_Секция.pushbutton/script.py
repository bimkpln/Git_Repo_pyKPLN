...
__title__ = "СИТИ_Заполнение параметров 'СИТИ_Этаж', 'СИТИ_Секция'"
__author__ = 'Kapustin Roman'
__doc__ = "Автоматическое заполнение параметров для классификатора.\n"\
        "Заполянет параметры 'СИТИ_Этаж', 'СИТИ_Секция' с возможностью аналитического поиска секции и этажа для элементов, выхлдящих за оси здания.'\n"\
        "Актуально для всех разделов АР!"
...
categoryList = [BuiltInCategory.OST_Walls, BuiltInCategory.OST_Ceilings,
                BuiltInCategory.OST_Windows, BuiltInCategory.OST_Floors, BuiltInCategory.OST_StairsRailing,
                BuiltInCategory.OST_Roofs, BuiltInCategory.OST_Doors, BuiltInCategory.OST_CurtainWallPanels, BuiltInCategory.OST_MechanicalEquipment, BuiltInCategory.OST_GenericModel,BuiltInCategory.OST_PlumbingFixtures]
