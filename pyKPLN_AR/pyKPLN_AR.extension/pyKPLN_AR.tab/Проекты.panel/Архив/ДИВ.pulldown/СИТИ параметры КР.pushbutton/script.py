...
__title__ = "Параметры СИТИ для КР нов"
__doc__ = '...' \
...
exceptions = [-2000700, -2000576, -2000924, -2009609, -2001342,
              ...
              -2003100, -2000279, -2000045, -2002000, -2009000,
              -2009003]

out = script.get_output()

categories = [
    DB.BuiltInCategory.OST_Walls,#0
    DB.BuiltInCategory.OST_Floors,#1
    DB.BuiltInCategory.OST_Windows,#2
    DB.BuiltInCategory.OST_GenericModel,#3 Обобщенные модели
    DB.BuiltInCategory.OST_StructuralFraming,#4 Каркас несущий
    DB.BuiltInCategory.OST_StructuralColumns,#5
    DB.BuiltInCategory.OST_StructuralFoundation, #6
    DB.BuiltInCategory.OST_MechanicalEquipment #7 Оборудование
    ]
...
presets.append(["ДИВ_RBS_Код по классификатору", "СИТИ_Классификатор", [-1], False, [], True, ""])
presets.append(["ДИВ_Секция_Текст", "СИТИ_Секция", [-1], True, sections, False, "от 1-9"])
presets.append(["ДИВ_Этаж_Текст", "СИТИ_Этаж", [-1], True, levels, False, "м1 либо 1-9"])
presets.append(["ДИВ_Наименование по классификатору", "СИТИ_Тип", [-1], False, [], False, ""])
presets.append(["ДИВ_Имя_классификатора", "СИТИ_Имя_классификатора", [-1], False, [], False, ""])
presets.append(["ДИВ_Комплект_документации", "СИТИ_Комплект_документации", [-1], False, [], False, ""])
presets.append(["КП_Марка_Номер", "СИТИ_Марка", [-1], False, [], False, ""])
presets.append(["ДИВ_Описание по классификатору", "СИТИ_Описание", [-1], False, [], False, ""])
presets.append(["ДИВ_Масса", "СИТИ_Масса", [3, 4, 7], False, [], False, ""])
presets.append(["КП_Расход арматуры", "СИТИ_Расход_Арматуры", [0, 1, 4, 5, 6], False, [], False, ""])
