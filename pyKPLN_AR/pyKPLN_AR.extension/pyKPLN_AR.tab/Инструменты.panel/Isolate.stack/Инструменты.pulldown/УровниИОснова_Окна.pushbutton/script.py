...
__title__ = "Уровни и основа окон"
__doc__ = 'Присвоение значения основы и наименования уровня элемента всем окнам (Наименованием семейства начинается с «120_»)' \
...
def logger(n):
	try:
		...
		filename = "{}-{}-{}_{}-{}-{}_({})_TOOLS_WINDOWS_HOST_LEVEL.txt".format(str(now.year), str(now.month), str(now.day), str(now.hour), str(now.minute), str(now.second), revit.username)
